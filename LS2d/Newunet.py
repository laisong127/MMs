...
class Insensee_3Dunet(nn.Module):
    def __init__(self,in_ch):
        ...
        self.con3d_brige = conv3d_up(208, 416)
        self.con3d_up4 = conv3d_up(416+208, 208)
        self.con3d_up3 = conv3d_up(208+104, 104)
        self.con3d_up2 = conv3d_up(104+52, 52)
        self.con3d_up1 = double_conv_block_3d(52+26, 26, nn.LeakyReLU())
